        ...
        <div class="row">
          <div class="col-lg-12 news-section">
			...
			<div class="table-responsive">
				<div id="tableheader">
		  		<?php echo anchor('adminpage/DP_Petugas/AddPetugas', '<button type="button" class="btn btn-themeBackground" style="float:left; margin-right:10px;">Add Petugas</button>') ?>
					<div class="search">
						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align:center;">
									...
									<?php echo anchor('adminpage/DP_Petugas/getDetail/'.$row['uid'], '<i class="fa fa-pencil"></i>', 'class="link-class"') ?> | 
									<?php echo anchor('adminpage/DP_Petugas/Delete/'.$row['idx'], '<i class="fa fa-trash"></i>', $onclick); ?></td>
							</tr>
							<?php }
							?>
						</tbody>

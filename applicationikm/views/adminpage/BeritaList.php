                    ...
                    <div class="col-lg-12 news-section">
                        ...
                        <div class="table-responsive">
                            <div id="tableheader">
                                ...
                                <?php echo anchor('adminpage/Berita/AddBerita', '<button type="button" class="btn btn-themeBackground" style="float:left; margin-right:10px;">Add News</button>') ?>
		  		                    <div class="search">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td style="text-align:center;">
											<?php echo anchor('adminpage/Berita/getDetail/'.$row['idx'], '<i class="fa fa-pencil"></i>', 'class="link-class"') ?>
                                            <?php $onclick = array('class'=> "link-class", 'onclick'=>"return confirm('Are you sure?')");?>
                                                <?php echo anchor('adminpage/Berita/Delete/'.$row['idx'], '<i class="fa fa-trash"></i>', $onclick); ?></td>
                                    </tr>
                                    <?php }
							?>
                            </tbody>

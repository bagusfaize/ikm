        ...
        <div class="row">
          <div class="col-lg-12 news-section">
			...
			<div class="table-responsive">
				...
				<?php echo anchor('adminpage/DP_Narasumber_Intruktur/NarasumberDanIntruktur_Add', '<button type="button" class="btn btn-themeBackground" style="float:left; margin-right:10px;">Add Narasumber</button>') ?>
		  			<div class="search">
				...
				<table cellpadding="0" cellspacing="0" border="0" id="table" class="table tinytable"   >
						...
						<!-- <?php echo "<pre>";print_r( $ProdukData); echo "</pre>"; ?> -->
							...
							<tr>
								...
								<?php echo anchor('adminpage/DP_Narasumber_Intruktur/getDetail/'.$row['idx'], '<i class="fa fa-pencil" style="width:6%"></i>', 'class="link-class"')  ?>  |
								<?php echo anchor('adminpage/DP_Narasumber_Intruktur/Delete/'.$row['idx'], '<i class="fa fa-trash" style="width:6%"></i>', $onclick); ?>  
								</td>	
							</tr>
							<?php }
							?>
...
<div class="modal fade" id="modalProduk" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo form_open('adminpage/DP_Narasumber_Intruktur/insert'); ?>

...
<section>
	<div class="container">
		<div class="row">   
        <?php echo form_open_multipart('adminpage/BeritaVideo/update'); ?>
			<div class="col-lg-12">
			<h4 class="section-title">Detail Berita</h4> 
		  	...
		  	<?php echo anchor('adminpage/BeritaVideo', '<button type="button" class="btn btn-secondary">Cancel</button>') ?>
		</div>
        <?php echo form_close(); ?>
	</div>
</section>

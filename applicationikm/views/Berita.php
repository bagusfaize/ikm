        ...
        <div class="row"><?php
              ...
              <div class="col-md-6 mb-4">
                <div class="card">
                  ...
                  <div class="p-3">
                      <?php echo anchor('Berita/DetailBerita/'.$row['idx'], $row['judul'], 'class="card-title"'); ?>
                    <div>
            ...
            <?php } ?><div class="col-md-12 mb-4">
              <?php echo anchor('Berita/LoadMore/'.$nextLoad, '<button style="width:100%;" type="button" class="btn btn-info">Load More</button>', 'class="card-title"'); ?>
            </div>
        </div>
      </div>

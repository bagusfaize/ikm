<body>
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="section-title">Detail Bahan Baku</h4>
                    <?php echo form_open('adminpage/DP_Bahan_Baku/update'); ?>
                        <div class="row">
                            <div class="col-md-12 mb-12">
                                <div class="form-group">
                                    <label for="usr">Nama Baku</label>
                        ...
                        <?php echo anchor('adminpage/DP_Bahan_Baku', '<button type="button" class="btn btn-secondary">Cancel</button>') ?>
                        <?php echo form_close(); ?>
                </div>
            </div>
        </div>

				...
				<table cellpadding="0" cellspacing="0" border="0" id="table" class="table tinytable">
						<thead>
							<tr>
								...
								<th><h3>Kategori Bahan Baku</h3></th>
								
								<th><h3>Name Baku</h3></th>
						...
						<tbody>
							...
							{ 
                                if($row['kategori'] == 1){ $kat = "Komoditas Pertanian dan Olahannya"; }
                                if($row['kategori'] == 2){ $kat = "Komoditas Kehutanan dan Olahannya"; }
                                if($row['kategori'] == 3){ $kat = "Komoditas Perikanan dan Olahannya"; }
                                if($row['kategori'] == 4){ $kat = "Komoditas Peternakan dan Olahannya"; }
                                if($row['kategori'] == 5){ $kat = "Komoditas Tambang dan Olahannya"; }
                                if($row['kategori'] == 6){ $kat = "Kimia dan Lainnya"; }
							...
							<td><?php echo $row['idx']; ?></td>
								...
								<td style="text-align:center;">
									...
									<?php echo anchor('adminpage/DP_Bahan_Baku/getDetail/'.$row['idx'], '<i class="fa fa-pencil"></i>', 'class="link-class"') ?> |
									<?php echo anchor('adminpage/DP_Bahan_Baku/Delete/'.$row['idx'], '<i class="fa fa-trash"></i>', $onclick); ?></td>
							</tr>
							<?php }
							?>
						</tbody>
...
<div class="modal fade" id="modalProduk" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo form_open('adminpage/DP_Bahan_Baku/insert'); ?>

						...
						<tbody>
							...
							<td><?php echo $row['idx']; ?></td>
								...
								<td style="text-align:center;">
									...
									<?php echo anchor('adminpage/DP_BB/Delete/'.$row['idx'], '<i class="fa fa-trash"></i>', $onclick); ?></td>
							</tr>
							<?php }
							?>
						</tbody>
...
<div class="modal fade" id="modalProduk" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <?php echo form_open('adminpage/DP_BB/insert'); ?>

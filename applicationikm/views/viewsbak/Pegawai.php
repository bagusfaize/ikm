  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 news-section">
        <h4 class="section-title">Pegawai</h4>
        <div class="row">
          <div class="col-md-12 mb-4 "><div class="table-responsive">
            <table class="table">
              <thead class="thead-dark">
                ...
                <tr>
                  <td><img src="<?php echo ASSET_PATH; ?>/assets/<?php echo $row['file']; ?>" height="128px"/></td>

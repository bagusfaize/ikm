...
<section>
	<div class="container">
		<div class="row">   
        <?php echo form_open_multipart('user/PetugasPendataan/update'); ?>
			<div class="col-lg-12">
			<h4 class="section-title">Detail Petugas</h4> 
		  	...
		  	<?php echo anchor('user/PetugasPendataan', '<button type="button" class="btn btn-secondary">Cancel</button>') ?>
		</div>
        <?php echo form_close(); ?>
	</div>
</section>

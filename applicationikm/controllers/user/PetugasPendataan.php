...
class PetugasPendataan extends CI_Controller {
	...
	public function getDetail($uid)
	{
		...
		$this->load->view('adminpage/Stylesheet');
		$this->load->view('user/Header');
		$this->load->view('user/Petugas_Detail', $data);
		$this->load->view('adminpage/Footer');
	}
	...
	public function update()
	{
		...
		echo "<script type='text/javascript'>window.location.href = '" . base_url() . "user/PetugasPendataan/getDetail/".$UsrID."';</script>";
	...
	public function Delete($idx)
	{
		...
		echo "<script type='text/javascript'>window.location.href = '" . base_url() . "user/PetugasPendataan';</script>";
	}
}

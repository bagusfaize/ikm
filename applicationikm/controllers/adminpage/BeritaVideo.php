...
class BeritaVideo extends CI_Controller {
	...
	{
		$data['BeritaData'] = $this->MBerita->get_dataBerita(3);		
		$this->load->view('adminpage/Stylesheet');
		$this->load->view('adminpage/Header');
		$this->load->view('adminpage/BeritaVideoList', $data);
	...
	{			
        ...
        $this->load->view('adminpage/Stylesheet');
        $this->load->view('adminpage/Header');
        $this->load->view('adminpage/BeritaVideoAdd');
	...
	public function insert()
	{
	   ...
	   if ( ! $this->upload->do_upload('fileimage'))
	   {
		...
		echo "<script type='text/javascript'>window.location.href = '" . base_url() . "adminpage/BeritaVideo/';</script>";
    }
	...
	{		
        ...
        $this->load->view('adminpage/Stylesheet');
        $this->load->view('adminpage/Header');
        $this->load->view('adminpage/BeritaVideoDetail', $data);
		$this->load->view('adminpage/FooterEditor');
    }
	...
	public function update()
	{
		...
		echo "<script type='text/javascript'>window.location.href = '" . base_url() . "adminpage/BeritaVideo/getDetail/".$idx."';</script>";
    }
